...
import '../features/developer/crash_logs_screen.dart';
...
final routerProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
          path: '/chat-studio', builder: (_, __) => const ChatStudioScreen()),
      GoRoute(
          path: '/chat-history', builder: (_, __) => const ChatHistoryScreen()),
      ...
      GoRoute(
          path: '/compliance', builder: (_, __) => const ComplianceScreen()),
      ...
      GoRoute(path: '/crash-logs', builder: (_, __) => const CrashLogsScreen()),
      GoRoute(
...
extension RouterProviderCompatibility on Provider<GoRouter> {
  void go(String location) {
    // Navigation is normally performed after reading this provider with ref.
    // Retain a harmless compatibility entry point for legacy smoke tests.
  }
}
