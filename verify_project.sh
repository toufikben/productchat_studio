...
for f in MainActivity.kt native/SeikaChannel.kt native/PatchMatchRemover.kt; do check "android/$f" "[ -f android/app/src/main/kotlin/com/productchat/studio/$f ]"; done
