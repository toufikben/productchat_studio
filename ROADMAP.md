...
- **2026-09-14 — دفعة الإصلاحات الأساسية (15/15):** تطبيق إصلاحات Android وiOS وCI وطبقة التطبيق والخدمات والاعتماديات وفحص الأسرار؛ توصيل Real-ESRGAN ONNX والتحقق من مساره؛ إضافة الثيم الفاتح وonboarding وProviderScope والتحقق المحلي من entitlement. بقي تشغيل Flutter (`pub get`, `gen-l10n`, `analyze`, `test`) ومراجعة SHA-256 الفعلي للنموذج قبل الإصدار.
