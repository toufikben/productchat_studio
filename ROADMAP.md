...
- [x] Qwen يبقى ميزة متقدمة مدفوعة اختيارية عبر WaveSpeed، مع Credits وحدود يومية؛ لا يُقدّم كميزة مجانية غير محدودة.
- [ ] قبل البيع: اختبار السعر الفعلي، خصم Credits بعد نجاح العملية فقط، معالجة الفشل/المهلة، ومفتاح WaveSpeed عبر Backend عند توفر الميزانية.
- [ ] إذا تعذر تمويل API: نخفي Qwen من الإصدار العام ونطلق الميزات المحلية الثلاث بدلاً من إضافة نموذج صغير أقل جودة باسم مضلل.
