...
The product IDs are code-level contracts only. They must also be created and activated in Google Play Console with matching one-time consumable products before a real purchase can succeed.
